    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={{ backgroundColor: Colors.background }}>
          ...
          {masterData.credits && masterData.credits.cast.length > 0 && (
            <View>
              <View style={{ marginLeft: "4%", marginTop: 30, marginBottom: 5 }}>
                <FontText fontSize={20} font={"Roboto-Bold"}>
                  Cast
          ...
          {masterData && masterData.recommendations && (
            <View>
              ...
              <View style={{ flex: 1, height: 270 }}>
                <MovieListScroll showType={"tv"} master_data={masterData.recommendations} navigation={navigation} />
              </View>
            </View>
          )}
        </View>
      ...
      >
        <AddMovieToListModal navigation={navigation} movie_key={object.id} show_type={SHOW_TYPE} movie_data={masterData} done={async () => {setWatchListModal(false)}} />
      </Modal>
    </View>
  );
};
