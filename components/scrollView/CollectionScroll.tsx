import { baseUrl342, descriptionFix, getMasterDetails, round } from "../../src/helper"
...
const CollectionScroll: React.FC<CollectionScrollProps> = ({ navigation, list }) => {
  ...
  const rowRenderer = (type, data: Part) => {
    return (
      <TouchableOpacity
        onPress={() => { moveToMovie(data.id) }} style={{ height: 150 }}>
